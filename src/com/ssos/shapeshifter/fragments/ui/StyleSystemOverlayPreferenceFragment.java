...
public class StyleSystemOverlayPreferenceFragment extends DashboardFragment implements Indexable {
    ...
    private void updateSettingsCards() {
        ...
        int settingsCards = Settings.System.getIntForUser(getContext().getContentResolver(),
                Settings.System.STYLE_OVERLAY_SETTINGS_CARDS, 0, UserHandle.USER_CURRENT);

        if (settingsCards == 0) {
            setDefaultSettingsCard(mOverlayManager);
        } else if (settingsCards == 1) {
